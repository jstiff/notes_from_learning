...
- A parse tree for a grammar G is a tree where
  ...
  - a meta-syntax for context free grammers.
  ...
  - Many extensions and variants of the original Backus–Naur notation are used; some are exactly defined, including
    1. extended Backus–Naur form (EBNF) Rust uses this...and it's the most common formalism to describe languages.
    2. Augmented Backus–Naur form (ABNF)

### Rust

Most of Rust's grammar is confined to the ASCII range of Unicode, and is described in this document by a dialect of Extended Backus-Naur Form (EBNF), specifically a dialect of EBNF supported by common automated LL(k) parsing tools such as llgen
